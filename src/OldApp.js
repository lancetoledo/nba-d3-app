  ...
  const staticPlayersData = [
    {
      ...
      "percentileRanks": {
        "pts": 98.11,   // 98th percentile for pts
        "ast": 90.56,  // 91st percentile for ast
        "reb": 75.67, // 76th percentile for reb
        "stl": 72.78,   // 73rd percentile for stl
        "blk": 65.22    // 65th percentile for blk
      }
    ...
    },
    {
      ...
      "percentileRanks": {
        "pts": 98.56,   // 99th percentile for pts
        "ast": 93.44,  // 93rd percentile for ast
        "reb": 86.78, // 87th percentile for reb
        "stl": 82.33,   // 82nd percentile for stl
        "blk": 73.44    // 73rd percentile for blk
      }
    },
    {
      "idPlayer": "34161168",
      ...
      "percentileRanks": {
        "pts": 99.00,   // 99th percentile for pts
        "ast": 87.89,  // 88th percentile for ast
        "reb": 79.00, // 79th percentile for reb
        "stl": 66.78,   // 67th percentile for stl
        "blk": 55.67    // 56th percentile for blk
      }
    },
    {
      "idPlayer": "34161165",
      ...
      "percentileRanks": {
        "pts": 99.44,   // 99th percentile for pts
        "ast": 86.78,  // 87th percentile for ast
        "reb": 94.56, // 95th percentile for reb
        "stl": 91.22,   // 91st percentile for stl
        "blk": 96.78    // 97th percentile for blk
      }
    }
  ]
